...
Thermostat.prototype.changePowerSaveMode = function() {
  this.powerSaveMode ? this.powerSaveMode = false : 
  this.powerSaveMode = true;
...
Thermostat.prototype.isMaximumTemperature = function() {
  if (this.powerSaveMode ===true && this.temperature > MAX_TEMPERATURE_PSM_ON) {
    return "MAX_TEMPERATURE_PSM_ON"
  } 
  if (this.powerSaveMode === false && this.temperature > MAX_TEMPERATURE_PSM_OFF ) {
